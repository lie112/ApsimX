...
namespace Models.CLEM.Activities
{
    ...
    public class RuminantActivityControlledMating : CLEMRuminantActivityBase, IValidatableObject, IHandlesActivityCompanionModels
    {
        ...
        public override List<ResourceRequest> RequestResourcesForTimestep(double argument = 0)
        {
            ...
            {
                if (female.Parameters.BreedDetails.ConceptionModel is null)
                    throw new ApsimXException(this, $"No conception details were found for [r={female.Parameters.BreedDetails.Name}]\r\nPlease add a conception component below the [r=RuminantType]");
                female.ActivityDeterminedConceptionRate = female.Parameters.BreedDetails.ConceptionModel.ConceptionRate(female);
